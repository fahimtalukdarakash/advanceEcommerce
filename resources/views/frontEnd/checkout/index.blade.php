                                ...
                                <div class="tab-content p-4" id="myTabContent">
                                    <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @endif
                                            <p class="text-danger" id="emailError">{{$errors->has('email') ? $errors->first('email') : ''}}</p>
                                        </div>
                                        <div class="form-group">
                                            <label>Mobile Number <span class="text-danger">*</span></label>
                                            @if(isset($customer->mobile))
                                                <input type="number" value="{{$customer->mobile}}" readonly id="mobile" name="mobile"/>
                                            @else
                                        ...
                                        <div class="form-group">
                                            ...
                                            <p class="text-danger">{{$errors->has('delivery_address') ? $errors->first('delivery_address') : ''}}</p>
                                        </div>
                                        <div class="mb-4">
                                            <input type="radio" checked id="checkbox1" value="cash" name="payment_type"/>
                                ...
                                <table class="table summery-table">
                                    ...
                                    @foreach($cartProducts as $cartProduct)
                                        <tr class="order-product">
                                            <td>{{$cartProduct->name}} : <span class="quantity"> &nbsp;  {{$cartProduct->price}} *{{$cartProduct->qty }}</span></td>
