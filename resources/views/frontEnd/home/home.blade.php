                                ...
                                <div class="product-hover-action">
                                    <ul class="cart-action">
                                        ...
                                        <li class="select-option">
                                            ...
                                            <a href="{{route('cart.direct-add',['id'=>$new_arrival_product->id])}}">Add to Cart</a>
                            ...
                            <div class="product-content">
                                <div class="inner">
                                    ...
                                    <div class="product-price-variant">
                                        <span class="price old-price">{{$new_arrival_product->regular_price}}</span>
                                        <span class="price current-price">{{$new_arrival_product->selling_price}}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
