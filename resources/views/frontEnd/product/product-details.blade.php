                    ...
                    @if($product->id != $category_product->id)
                        <div class="slick-single-layout">
                            <div class="axil-product">
                                <div class="thumbnail">
                                    <a href="{{route('product.details',$category_product->id)}}">
                                    ...
                                    <div class="product-hover-action">
                                        <ul class="cart-action">
                                            ...
                                            <li class="select-option"><a href="{{route('cart.direct-add',['id'=>$category_product->id])}}">Add to Cart</a></li>
                                ...
                                <div class="product-content">
                                    <div class="inner">
                                        <h5 class="title"><a href="{{route('product.details',$category_product->id)}}">{{$category_product->name}}</a></h5>
                                        <div class="product-price-variant">
                                            <span class="price old-price">&#2547; {{$category_product->regular_price}}</span>
                                            <span class="price current-price">&#2547; {{$category_product->selling_price}}</span>
                                        </div>
                                        <div class="color-variant-wrapper">
                                            <ul class="color-variant">
                                                <li class="color-extra-01 active"><span><span class="color"></span></span>
